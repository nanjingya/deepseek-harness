...
export interface RpcMethodMap {
  ...
  'host.listSessionDirectory': HostApi['listSessionDirectory']
  'host.searchSessionFiles': HostApi['searchSessionFiles']
  'host.listSessionTerminals': HostApi['listSessionTerminals']
  'host.openSessionTerminal': HostApi['openSessionTerminal']
  'host.readSessionTerminal': HostApi['readSessionTerminal']
  'host.sendSessionTerminal': HostApi['sendSessionTerminal']
  'host.closeSessionTerminal': HostApi['closeSessionTerminal']
