...
import {
  ...
  hostListSessionDirectoryRequestSchema,
  hostSearchSessionFilesRequestSchema,
  hostListSessionTerminalsRequestSchema,
  hostOpenSessionTerminalRequestSchema,
  hostReadSessionTerminalRequestSchema,
  hostSendSessionTerminalRequestSchema,
  hostCloseSessionTerminalRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.listSessionDirectory': { schema: hostListSessionDirectoryRequestSchema, invoke: (api, r, signal) => api.host.listSessionDirectory(r, signal) },
  'host.searchSessionFiles': { schema: hostSearchSessionFilesRequestSchema, invoke: (api, r, signal) => api.host.searchSessionFiles(r, signal) },
  'host.listSessionTerminals': { schema: hostListSessionTerminalsRequestSchema, invoke: (api, r) => api.host.listSessionTerminals(r) },
  'host.openSessionTerminal': { schema: hostOpenSessionTerminalRequestSchema, invoke: (api, r, signal) => api.host.openSessionTerminal(r, signal) },
  'host.readSessionTerminal': { schema: hostReadSessionTerminalRequestSchema, invoke: (api, r) => api.host.readSessionTerminal(r) },
  'host.sendSessionTerminal': { schema: hostSendSessionTerminalRequestSchema, invoke: (api, r, signal) => api.host.sendSessionTerminal(r, signal) },
  'host.closeSessionTerminal': { schema: hostCloseSessionTerminalRequestSchema, invoke: (api, r) => api.host.closeSessionTerminal(r) },
